...
extern "C" {
    ...
    fn rte_ring_count_(r: *mut rte_ring) -> u32;
    fn rte_ring_enqueue_(r: *mut rte_ring, obj: *mut c_void) -> c_int;
    fn rte_ring_dequeue_(r: *mut rte_ring, obj_p: *mut *mut c_void) -> c_int;
    fn rte_ring_dequeue_bulk_(r: *mut rte_ring, obj_table: *mut *mut c_void, n: c_int, available: *mut c_int) -> c_int;
...
#[inline]
pub unsafe fn rte_ring_count(r: *mut rte_ring) -> u32 {
    rte_ring_count_(r)
}
...
#[inline]
pub unsafe fn rte_ring_dequeue_bulk(r: *mut rte_ring, obj_table: *mut *mut c_void, n: c_int, available: *mut c_int) -> c_int {
    rte_ring_dequeue_bulk_(r, obj_table, n, available)
}
