...
__thread struct hashtable *accept_result = NULL;
__thread struct hashtable *pop_result = NULL;
...
static demi_queues global_queues = {NULL, NULL, NULL, NULL};
static __thread demi_queues worker_queues = {NULL, NULL, NULL, NULL};

static __thread demi_queues *queues = NULL;

void queue_man_init_worker(void)
{
